...
function showDefaultMessage() {
  // Get reference to the default message element
...
function showSuccessMessage() {
  // Get references to the success and default message elements
  const successMessage = document.getElementById('success-message');
  const defaultMessage = document.getElementById('default-message');
  
  // Hide the default message and display the success message
...
function showErrorMessage() {
  // Get references to the error and default message elements
  const errorMessage = document.getElementById('error-message');
  const defaultMessage = document.getElementById('default-message');
  
  // Hide the default message and display the error message
  defaultMessage.style.display = 'none';
